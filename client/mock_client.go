...
func (_m *MockIDBClient) GetPortalUserID(ctx context.Context, providerUserID string) (types.UserID, error) {
...
func (_m *MockIDBClient) GetPortalUserIDFromProviderUserID(ctx context.Context, providerUserID types.ProviderUserID) (types.UserID, error) {
	ret := _m.Called(ctx, providerUserID)
...
func (_m *MockIDBClient) GetUserPermissionByUserID(ctx context.Context, providerUserID types.ProviderUserID) (*types.UserPermissions, error) {
	ret := _m.Called(ctx, providerUserID)
